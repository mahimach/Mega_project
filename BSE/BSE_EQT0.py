...
file_path = r"E:/Python_Backend_Internship_Assignments/Day4/BSE"
...
# Sample values (replace these with actual values you'd use in your application)
pagetype = '0'
rbType = 'D'  # or 'M' or 'Y'
scripcode = '503162'
...
if response.status_code == 200:
    ...
    if content_disposition:
        ...
        filename = "downloaded_file.csv"  # Fallback filename
